...
- 폐쇄적 신비주의  
- 새로운 기기나 서비스 개발 간 내부 비밀리에 진행 (폐쇄적)
- Apple Mania 계층이 존재
- HomeCare, HealthKit, 개인비서서비스, Siri, iPhone, iWatch, ApplePay...
- Apple의 문제점
  - 아이폰의 비중이 너무 큼
    - 그래서 아이폰 외의 사업을 확장 하고 있음
- Google과의 차이점 
  - 애플
    - 폐쇄적, 상용화 가능 수준의 기술 완결성 추구
      - 선제적인 것보다 확실한, 완벽한 것을 추구
    - 독자 생태계 기반 + 제한적 제휴 / 협력
  - 구글 
    - 개발적, 혁신 기술의 선제적 시도 
    - 개방을 통한 참여자 확대
...
- 차별화된 Home IoT기반 & 전략
- 삼성, 하이닉스 등이 반도체를 잘 만드는 이유?
  - 한국의 젓가락 문화(?)
- 베트남 수출 20%가 삼성?!
  - 삼성 스마트폰의 대부분은 베트남에서 생산
